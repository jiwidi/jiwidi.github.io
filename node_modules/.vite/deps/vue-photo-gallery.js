import {
  __esm,
  __toCommonJS
} from "./chunk-ZAZJWD6H.js";

// vite:dep-pre-bundle:external-conversion:/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/photoswipe.css
var photoswipe_exports = {};
import "/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/photoswipe.css";
var init_photoswipe = __esm({
  "vite:dep-pre-bundle:external-conversion:/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/photoswipe.css"() {
  }
});

// vite:dep-pre-bundle:external-conversion:/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/default-skin/default-skin.css
var default_skin_exports = {};
import "/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/default-skin/default-skin.css";
var init_default_skin = __esm({
  "vite:dep-pre-bundle:external-conversion:/Users/jiwidi/projects/github/personal_vue/node_modules/photoswipe/dist/default-skin/default-skin.css"() {
  }
});

// node_modules/vue-photo-gallery/dist/vue-photo-gallery.esm.js
...
var _hide = _descriptors ? function(object, key, value2) {
  return _objectDp.f(object, key, _propertyDesc(1, value2));
  ...
  (function(root, factory) {
    ...
    var PhotoSwipe = function(template, UiClass, items, options) {
      var framework = {
        ...
        arraySearch: function(array, value2, key) {
          var i = array.length;
          while (i--) {
...
var photoswipeUiDefault = createCommonjsModule(function(module, exports) {
  (function(root, factory) {
    ...
    var PhotoSwipeUI_Default = function(pswp2, framework) {
      var ui = this;
      var _overlayUIUpdated = false, _controlsVisible = true, _fullscrenAPI, _controls, _captionContainer, _fakeCaptionContainer, _indexIndicator, _shareButton, _shareModal, _shareModalHidden = true, _initalCloseOnScrollValue, _isIdle, _listen, _loadingIndicator, _loadingIndicatorHidden, _loadingIndicatorTimeout, _galleryHasOneSlide, _options, _defaultUIOptions = {
        ...
        getImageURLForShare: function() {
          return pswp2.currItem.src || "";
        },
        getPageURLForShare: function() {
          return window.location.href;
        },
        getTextForShare: function() {
          return pswp2.currItem.title || "";
        },
        indexIndicatorSep: " / ",
      ...
      var _onControlsTap = function(e) {
        ...
        return !pswp2.likelyTouchDevice || _options.mouseUsed || screen.width > _options.fitControlsWidth;
        ...
        pswp2.shout("shareLinkClick", e, target);
        if (!target.href) {
          return false;
        }
        ...
        if (_options.fullscreenEl && !framework.features.isOldAndroid) {
          ...
          if (_fullscrenAPI) {
            ...
            ui.updateFullscreen();
            framework.addClass(pswp2.template, "pswp--supports-fs");
          } else {
            framework.removeClass(pswp2.template, "pswp--supports-fs");
          }
        }
        ...
        if (_options.preloaderEl) {
          ...
          _listen("beforeChange", function() {
            ...
            _loadingIndicatorTimeout = setTimeout(function() {
              if (pswp2.currItem && pswp2.currItem.loading) {
                if (!pswp2.allowProgressiveImg() || pswp2.currItem.img && !pswp2.currItem.img.naturalWidth) {
      ...
      ui.init = function() {
        framework.extend(pswp2.options, _defaultUIOptions, true);
        _options = pswp2.options;
        _controls = framework.getChildByClass(pswp2.scrollWrap, "pswp__ui");
        _listen = pswp2.listen;
        _setupHidingControlsDuringGestures();
        _listen("beforeChange", ui.update);
        _listen("doubleTap", function(point) {
          var initialZoomLevel = pswp2.currItem.initialZoomLevel;
          if (pswp2.getZoomLevel() !== initialZoomLevel) {
            pswp2.zoomTo(initialZoomLevel, point, 333);
          } else {
            pswp2.zoomTo(_options.getDoubleTapZoom(false, pswp2.currItem), point, 333);
          }
        });
        ...
        _listen("bindEvents", function() {
          ...
          framework.bind(pswp2.scrollWrap, "pswpTap", ui.onGlobalTap);
          if (!pswp2.likelyTouchDevice) {
            framework.bind(pswp2.scrollWrap, "mouseover", ui.onMouseOver);
          }
        });
        _listen("unbindEvents", function() {
          if (!_shareModalHidden) {
          ...
          framework.unbind(pswp2.scrollWrap, "pswpTap", ui.onGlobalTap);
          framework.unbind(pswp2.scrollWrap, "mouseover", ui.onMouseOver);
          if (_fullscrenAPI) {
      ...
      ui.update = function() {
        if (_controlsVisible && pswp2.currItem) {
          ui.updateIndexIndicator();
          if (_options.captionEl) {
            _options.addCaptionHTMLFn(pswp2.currItem, _captionContainer);
            _togglePswpClass(_captionContainer, "caption--empty", !pswp2.currItem.title);
          }
      ...
      ui.updateFullscreen = function(e) {
        if (e) {
          setTimeout(function() {
            pswp2.setScrollOffset(0, framework.getScrollY());
          }, 50);
        }
        framework[(_fullscrenAPI.isFullscreen() ? "add" : "remove") + "Class"](pswp2.template, "pswp--fs");
      };
      ui.updateIndexIndicator = function() {
        if (_options.counterEl) {
          _indexIndicator.innerHTML = pswp2.getCurrentIndex() + 1 + _options.indexIndicatorSep + _options.getNumItemsFn();
        }
      };
      ui.onGlobalTap = function(e) {
        ...
        if (e.detail && e.detail.pointerType === "mouse") {
          ...
          if (framework.hasClass(target, "pswp__img")) {
            if (pswp2.getZoomLevel() === 1 && pswp2.getZoomLevel() <= pswp2.currItem.fitRatio) {
              if (_options.clickToCloseNonZoomable) {
                pswp2.close();
              }
            } else {
              pswp2.toggleDesktopZoom(e.detail.releasePoint);
            }
          }
        } else {
        ...
        if (api) {
          api.enter = function() {
            ...
            if (this.enterK === "webkitRequestFullscreen") {
              pswp2.template[this.enterK](Element.ALLOW_KEYBOARD_INPUT);
            } else {
              return pswp2.template[this.enterK]();
            }
          };
          api.exit = function() {
...
var PhotoGallery = {
  render: function render() {
    ...
    return _c("div", { ref: "photoGallery", staticClass: "pswp", attrs: { "tabindex": "-1", "role": "dialog", "aria-hidden": "true" } }, [_c("div", { staticClass: "pswp__bg" }), _vm._v(" "), _vm._m(0)]);
  },
...
var LibraryModule = {
  ...
  install: function install(Vue) {
    ...
    Vue.$photoGallery = {
      open: function open2(index, images, options) {
...
var vue_photo_gallery_esm_default = LibraryModule;
export {
  PhotoGallery,
  vue_photo_gallery_esm_default as default
};
/*! Bundled license information:

vue-photo-gallery/dist/vue-photo-gallery.esm.js:
  ...
  * Copyright (c) 2017 Dmitry Semenov; *)
*/
//# sourceMappingURL=vue-photo-gallery.js.map
